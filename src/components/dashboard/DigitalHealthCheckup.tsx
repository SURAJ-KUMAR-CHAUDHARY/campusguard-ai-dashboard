        ...
        <div className="relative w-32 h-32">
          <svg className="w-full h-full -rotate-90" viewBox="0 0 100 100">
            ...
            <circle
              ...
              style={{
                filter: "drop-shadow(0 0 10px hsl(var(--success) / 0.5))",
              }}
            />
            <defs>
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center">
            <span className="text-2xl font-bold text-success neon-text-green">GOOD</span>
            <span className="text-xs text-muted-foreground">{healthScore}% Secure</span>
          </div>
        </div>
      </div>
        ...
        <div className="space-y-2">
          {insights.map((insight, index) => {
            ...
            return (
              <div
                key={index}
                className={`flex items-center gap-3 p-3 rounded-xl ${styles.bg} transition-all hover:scale-[1.02]`}
              >
